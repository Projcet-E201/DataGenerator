...
public class AirOutMpaManager extends AbstractDataManager<AirOutMpa> {
	...
	public AirOutMpaManager(DataSender dataSender, ChunkDataSender chunkDataSender, SensorSender sensorSender) {
		super(dataSender, chunkDataSender, sensorSender, DataType.AIR_OUT_MPA);
	}

	@Override
	protected AirOutMpa createDataInstance(String dataType) {
		return new AirOutMpa(dataSender, chunkDataSender, sensorSender, dataType);
	}
}